...
export function Model(props) {
  ...
  return (
    <group scale={2} position={[0, -11.9, 0]} {...props} dispose={null}>
      ...
      { /* 
      <group position={[0.09, 2.02, 4.64]} scale={1.33}>
        <mesh castShadow receiveShadow geometry={nodes.Bird.geometry} material={materials.Lowpoly_Flaoting_Islands_PortTexture} position={[-2.73, 7.91, -1.51]} rotation={[-2.68, 0.84, 2.92]} />
        <mesh castShadow receiveShadow geometry={nodes['Bird_(1)'].geometry} material={materials.Lowpoly_Flaoting_Islands_PortTexture} position={[-6.55, 7.84, -4.84]} rotation={[-1.4, -1.05, -1.16]} />
        <mesh castShadow receiveShadow geometry={nodes['Bird_(2)'].geometry} material={materials.Lowpoly_Flaoting_Islands_PortTexture} position={[0.01, 8.43, 3.42]} rotation={[-2.55, -0.08, -2.8]} />
        <mesh castShadow receiveShadow geometry={nodes['Bird_(3)'].geometry} material={materials.Lowpoly_Flaoting_Islands_PortTexture} position={[-8.58, 8.07, -4.7]} rotation={[-2.68, 0.53, 2.99]} />
      </group>
      */ }
      <group position={[0.09, 2.02, 4.64]} scale={1.33}>
      ...
      <mesh castShadow receiveShadow geometry={nodes.M_Smoke.geometry} material={materials.Lowpoly_Flaoting_Islands_PortTexture} position={[-0.43, 12.62, 9.07]} rotation={[-Math.PI, 0, -Math.PI]} />
