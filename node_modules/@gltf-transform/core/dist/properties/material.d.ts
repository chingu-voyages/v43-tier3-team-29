...
export declare class Material extends ExtensibleProperty {
    readonly propertyType = PropertyType.MATERIAL;
    /**********************************************************************************************
     * Constants.
     */
    static AlphaMode: Record<string, GLTF.MaterialAlphaMode>;
    private baseColorTextureInfo;
    private emissiveTextureInfo;
    private normalTextureInfo;
    private occlusionTextureInfo;
    private metallicRoughnessTextureInfo;
    ...
    setNormalScale(normalScale: number): this;
    /**
    ...
    setOcclusionStrength(occlusionStrength: number): this;
    /**
     ...
     * `metallicRoughnessTexture`. See {@link getMetallicRoughnessTexture}.
     */
    setRoughnessFactor(roughnessFactor: number): this;
    /**
     ...
     * `metallicRoughnessTexture`. See {@link getMetallicRoughnessTexture}.
     */
    setMetallicFactor(metallicFactor: number): this;
    /**
